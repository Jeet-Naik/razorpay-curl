...
<input type="hidden" name="surl" id="surl" value="http://localhost/razorpay-curl/success.php"> 
<input type="hidden" name="furl" id="furl" value="http://localhost/razorpay-curl/failed.php"> 
  ...
  <div class="container">
    ...
    <div class="row align-items-center">
       <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" id="amount" name="amount" placeholder="amount" value="150.00" readonly="readonly">
      </div>
      <div class="form-group col-md-6">
